...
public class CLDRBaseLocaleDataMetaInfo
implements LocaleDataMetaInfo {
    ...
    static {
        parentLocalesMap.put(Locale.forLanguageTag("fr-HT"), new String[]{"", "ht"});
        resourceNameToLocales.put("AvailableLocales", " en en-Latn-US en-US en-US-POSIX");
        parentLocalesMap.put(Locale.forLanguageTag("es-419"), new String[]{"", "es-AR", "es-BO", "es-BR", "es-BZ", "es-CL", "es-CO", "es-CR", "es-CU", "es-DO", "es-EC", "es-GT", "es-HN", "es-MX", "es-NI", "es-PA", "es-PE", "es-PR", "es-PY", "es-SV", "es-US", "es-UY", "es-VE"});
        parentLocalesMap.put(Locale.ROOT, new String[]{"", "az-Arab", "az-Cyrl", "bal-Latn", "blt-Latn", "bm-Nkoo", "bs-Cyrl", "byn-Latn", "cu-Glag", "dje-Arab", "dyo-Arab", "en-Dsrt", "en-Shaw", "ff-Adlm", "ff-Arab", "ha-Arab", "iu-Latn", "kk-Arab", "ks-Deva", "ku-Arab", "ky-Arab", "ky-Latn", "ml-Arab", "mn-Mong", "mni-Mtei", "ms-Arab", "pa-Arab", "sat-Deva", "sd-Deva", "sd-Khoj", "sd-Sind", "shi-Latn", "so-Arab", "sr-Latn", "sw-Arab", "tg-Arab", "ug-Cyrl", "uz-Arab", "uz-Cyrl", "vai-Latn", "wo-Arab", "yo-Arab", "yue-Hans", "zh-Hant"});
        parentLocalesMap.put(Locale.forLanguageTag("zh-Hant-HK"), new String[]{"", "zh-Hant-MO"});
        parentLocalesMap.put(Locale.forLanguageTag("en-001"), new String[]{"", "en-150", "en-AG", "en-AI", "en-AU", "en-BB", "en-BM", "en-BS", "en-BW", "en-BZ", "en-CC", "en-CK", "en-CM", "en-CX", "en-CY", "en-DG", "en-DM", "en-ER", "en-FJ", "en-FK", "en-FM", "en-GB", "en-GD", "en-GG", "en-GH", "en-GI", "en-GM", "en-GY", "en-HK", "en-IE", "en-IL", "en-IM", "en-IN", "en-IO", "en-JE", "en-JM", "en-KE", "en-KI", "en-KN", "en-KY", "en-LC", "en-LR", "en-LS", "en-MG", "en-MO", "en-MS", "en-MT", "en-MU", "en-MV", "en-MW", "en-MY", "en-NA", "en-NF", "en-NG", "en-NR", "en-NU", "en-NZ", "en-PG", "en-PK", "en-PN", "en-PW", "en-RW", "en-SB", "en-SC", "en-SD", "en-SG", "en-SH", "en-SL", "en-SS", "en-SX", "en-SZ", "en-TC", "en-TK", "en-TO", "en-TT", "en-TV", "en-TZ", "en-UG", "en-VC", "en-VG", "en-VU", "en-WS", "en-ZA", "en-ZM", "en-ZW"});
        parentLocalesMap.put(Locale.forLanguageTag("pt-PT"), new String[]{"", "pt-AO", "pt-CH", "pt-CV", "pt-FR", "pt-GQ", "pt-GW", "pt-LU", "pt-MO", "pt-MZ", "pt-ST", "pt-TL"});
        parentLocalesMap.put(Locale.forLanguageTag("no"), new String[]{"", "nb", "nn", "no-NO"});
        parentLocalesMap.put(Locale.forLanguageTag("en-IN"), new String[]{"", "hi-Latn"});
        parentLocalesMap.put(Locale.forLanguageTag("en-150"), new String[]{"", "en-AT", "en-BE", "en-CH", "en-DE", "en-DK", "en-FI", "en-NL", "en-SE", "en-SI"});
    ...
    private static class TZCanonicalIDMapHolder {
        static final Map<String, String> tzCanonicalIDMap = HashMap.newHashMap(451);

        private TZCanonicalIDMapHolder() {
        }
