...
public class SunHints {
    ...
    public static final int INTVAL_RESOLUTION_VARIANT_BASE = 1;
    public static final int INTVAL_RESOLUTION_VARIANT_SIZE_FIT = 2;
    public static final int INTVAL_RESOLUTION_VARIANT_DPI_FIT = 3;
    ...
    public static final Object VALUE_RESOLUTION_VARIANT_DEFAULT = new Value(KEY_RESOLUTION_VARIANT, 0, "Choose image resolutions based on a defaultheuristic");
    public static final Object VALUE_RESOLUTION_VARIANT_BASE = new Value(KEY_RESOLUTION_VARIANT, 1, "Use only the standard resolution of an image");
    public static final Object VALUE_RESOLUTION_VARIANT_SIZE_FIT = new Value(KEY_RESOLUTION_VARIANT, 2, "Choose image resolutions based on the DPIof the screen and transformin the Graphics2D context");
    public static final Object VALUE_RESOLUTION_VARIANT_DPI_FIT = new Value(KEY_RESOLUTION_VARIANT, 3, "Choose image resolutions based only on the DPI of the screen");
    ...
    public static class Value {
        ...
        private static synchronized void register(Key key, Value value) {
            ...
            if (ValueObjects[kindex][vindex = value.getIndex()] != null) {
                throw new InternalError("duplicate index: " + vindex);
            }
            Value.ValueObjects[kindex][vindex] = value;
        }
