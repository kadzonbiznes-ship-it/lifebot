 ...
 *  com.sun.jna.platform.win32.WinNT$ACCESS_ALLOWED_ACE
 *  com.sun.jna.platform.win32.WinNT$ACCESS_DENIED_ACE
 ...
 *  com.sun.jna.platform.win32.WinNT$SYSTEM_LOGICAL_PROCESSOR_INFORMATION$AnonymousUnionPayload
 */
...
BaseTSD {
    ...
    public static final int LANG_SYSTEM_DEFAULT = LocaleMacros.MAKELANGID((int)0, (int)2);
    public static final int LANG_USER_DEFAULT = LocaleMacros.MAKELANGID((int)0, (int)1);
    public static final WinDef.LCID LOCALE_SYSTEM_DEFAULT = LocaleMacros.MAKELCID((int)LANG_SYSTEM_DEFAULT, (int)0);
    public static final WinDef.LCID LOCALE_USER_DEFAULT = LocaleMacros.MAKELCID((int)LANG_USER_DEFAULT, (int)0);
    public static final WinDef.LCID LOCALE_NEUTRAL = LocaleMacros.MAKELCID((int)LocaleMacros.MAKELANGID((int)0, (int)0), (int)0);
    public static final WinDef.LCID LOCALE_INVARIANT = LocaleMacros.MAKELCID((int)LocaleMacros.MAKELANGID((int)127, (int)0), (int)0);
