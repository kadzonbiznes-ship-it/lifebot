...
public abstract class Structure {
    ...
    protected Object readField(StructField structField) {
        ...
        if (fieldType.equals(String.class) || fieldType.equals(WString.class)) {
            if (result != null) {
                ...
                if (previous != null) {
                    NativeStringTracking.access$002((NativeStringTracking)current, (NativeString)NativeStringTracking.access$000((NativeStringTracking)previous));
                }
            } else {
    ...
    private void writeField(StructField structField, Object value) {
        ...
        if (String.class == fieldType || WString.class == fieldType) {
            if (value != null) {
                ...
                NativeStringTracking previous = this.nativeStrings.put(structField.name, current);
                if (previous != null && value.equals(NativeStringTracking.access$100((NativeStringTracking)previous))) {
                    NativeStringTracking.access$002((NativeStringTracking)current, (NativeString)NativeStringTracking.access$000((NativeStringTracking)previous));
                    return;
                }
                ...
                NativeStringTracking.access$002((NativeStringTracking)current, (NativeString)nativeString);
    ...
    static <T extends Structure> int size(Class<T> type, T value) {
        ...
        int n = sz = info != null && !LayoutInfo.access$200(info) ? LayoutInfo.access$300(info) : -1;
        if (sz == -1) {
            if (value == null) {
    ...
    int calculateSize(boolean force, boolean avoidFFIType) {
        ...
        if (info == null || this.alignType != LayoutInfo.access$400(info) || this.typeMapper != LayoutInfo.access$500(info)) {
            info = this.deriveLayout(force, avoidFFIType);
        }
        if (info != null) {
            this.structAlignment = LayoutInfo.access$600(info);
            this.structFields = LayoutInfo.access$700(info);
            if (!LayoutInfo.access$200(info)) {
                cacheStructureLock.readLock().lock();
                try {
            ...
            size = LayoutInfo.access$300(info);
        }
        return size;
    }
    ...
    private LayoutInfo deriveLayout(boolean force, boolean avoidFFIType) {
        ...
        for (Field field : fields) {
            ...
            if (Modifier.isPublic(field.getModifiers())) {
                ...
                LayoutInfo.access$602(info, Math.max(LayoutInfo.access$600(info), fieldAlignment));
                ...
                LayoutInfo.access$700(info).put(structField.name, structField);
            }
            firstField = false;
        }
        if (calculatedSize > 0) {
            int size = this.addPadding(calculatedSize, LayoutInfo.access$600(info));
    ...
    FFIType getFieldTypeInfo(StructField f) {
        ...
        return FFIType.access$900(value, type);
    }
    ...
    private static class LayoutInfo {
        ...
        static /* synthetic */ boolean access$200(LayoutInfo x0) {
            return x0.variable;
        }

        static /* synthetic */ int access$300(LayoutInfo x0) {
            return x0.size;
        }

        static /* synthetic */ int access$400(LayoutInfo x0) {
            return x0.alignType;
        }

        static /* synthetic */ TypeMapper access$500(LayoutInfo x0) {
            return x0.typeMapper;
        }

        static /* synthetic */ int access$600(LayoutInfo x0) {
            return x0.alignment;
        }

        static /* synthetic */ Map access$700(LayoutInfo x0) {
            return x0.fields;
        }
