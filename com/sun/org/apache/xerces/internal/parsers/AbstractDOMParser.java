...
extends AbstractXMLDocumentParser {
    ...
    public void startGeneralEntity(String name, XMLResourceIdentifier identifier, String encoding, Augmentations augs) throws XNIException {
        if (!this.fDeferNodeExpansion) {
            ...
            if (!this.fCreateEntityRefNodes) {
                ...
                ((NodeImpl)((Object)er)).setReadOnly(true, true);
            }
        } else {
            int er = this.fDeferredDocumentImpl.createDeferredEntityReference(name, identifier == null ? null : identifier.getExpandedSystemId());
        ...
        if (!this.fDeferNodeExpansion) {
            if (this.fDocumentClassName.equals(DEFAULT_DOCUMENT_CLASS_NAME)) {
                ...
                try {
                    ...
                    this.fDocument = (Document)documentClass.getConstructor(new Class[0]).newInstance(new Object[0]);
                ...
                catch (ClassNotFoundException documentClass) {
                }
                catch (Exception e) {
    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs) throws XNIException {
        if (!this.fDeferNodeExpansion) {
            ...
            this.setCharacterData(false);
            if (augs != null && (elementPSVI = (ElementPSVI)augs.getItem("ELEMENT_PSVI")) != null && this.fNamespaceAware) {
    ...
    public void endElement(QName element, Augmentations augs) throws XNIException {
        if (!this.fDeferNodeExpansion) {
            ElementPSVI elementPSVI;
            if (augs != null && this.fDocumentImpl != null && (this.fNamespaceAware || this.fStorePSVI) && (elementPSVI = (ElementPSVI)augs.getItem("ELEMENT_PSVI")) != null) {
    ...
    protected final void handleBaseURI(int node) {
        ...
        if (nodeType == 1) {
            ...
            if (baseURI != null && !baseURI.equals(this.fDeferredDocumentImpl.getDocumentURI())) {
                this.fDeferredDocumentImpl.setDeferredAttribute(node, "xml:base", "http://www.w3.org/XML/1998/namespace", baseURI, true, false, null);
            }
        } else if (nodeType == 7) {
            String baseURI = this.fDeferredDocumentImpl.getNodeValueString(this.fCurrentNodeIndex, false);
            if (baseURI == null) {
    ...
    public void internalEntityDecl(String name, XMLString text, XMLString nonNormalizedText, Augmentations augs) throws XNIException {
        ...
        if (this.fDocumentTypeIndex != -1) {
            ...
            if (!found) {
                int entityIndex = this.fDeferredDocumentImpl.createDeferredEntity(name, null, null, null, this.fBaseURIStack.peek());
    ...
    public void notationDecl(String name, XMLResourceIdentifier identifier, Augmentations augs) throws XNIException {
        ...
        if (this.fDocumentImpl != null && this.fDocumentType != null && (notations = this.fDocumentType.getNotations()).getNamedItem(name) == null) {
    ...
    protected Element createElementNode(QName element) {
        Element el = null;
        el = this.fNamespaceAware ? (this.fDocumentImpl != null ? this.fDocumentImpl.createElementNS(element.uri, element.rawname, element.localpart) : this.fDocument.createElementNS(element.uri, element.rawname)) : this.fDocument.createElement(element.rawname);
        return el;
    }

    protected Attr createAttrNode(QName attrQName) {
        Attr attr = null;
        attr = this.fNamespaceAware ? (this.fDocumentImpl != null ? this.fDocumentImpl.createAttributeNS(attrQName.uri, attrQName.rawname, attrQName.localpart) : this.fDocument.createAttributeNS(attrQName.uri, attrQName.rawname)) : this.fDocument.createAttribute(attrQName.rawname);
        return attr;
    }
