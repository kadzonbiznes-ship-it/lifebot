...
ChangeListener {
    ...
    static void showMnemonics(boolean show, Component c) {
        ...
        if (show) {
            ...
            windowListener = new /* Unavailable Anonymous Inner Class!! */;
    ...
    static /* synthetic */ int access$002(int x0) {
        altPressedEventCount = x0;
        return altPressedEventCount;
    }

    static /* synthetic */ boolean access$102(boolean x0) {
        selectMenuOnAltReleased = x0;
        return selectMenuOnAltReleased;
    }
}
