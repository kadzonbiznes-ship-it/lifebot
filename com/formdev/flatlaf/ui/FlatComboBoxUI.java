...
FlatStylingSupport.StyleableLookupProvider {
    ...
    protected void configureEditor() {
        ...
        if (SystemInfo.isMacOS && this.editor instanceof JTextComponent) {
            ...
            new EditorDelegateAction(this, inputMap, KeyStroke.getKeyStroke("UP"));
            new EditorDelegateAction(this, inputMap, KeyStroke.getKeyStroke("KP_UP"));
            new EditorDelegateAction(this, inputMap, KeyStroke.getKeyStroke("DOWN"));
            new EditorDelegateAction(this, inputMap, KeyStroke.getKeyStroke("KP_DOWN"));
            new EditorDelegateAction(this, inputMap, KeyStroke.getKeyStroke("HOME"));
            new EditorDelegateAction(this, inputMap, KeyStroke.getKeyStroke("END"));
        }
    }
    ...
    static /* synthetic */ JComboBox access$4100(FlatComboBoxUI x0) {
        return x0.comboBox;
    }

    static /* synthetic */ JComboBox access$4200(FlatComboBoxUI x0) {
        return x0.comboBox;
    }
