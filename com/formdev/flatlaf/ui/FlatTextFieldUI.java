 ...
 *  com.formdev.flatlaf.ui.FlatTextFieldUI$FlatTextFieldLayout
...
implements FlatStylingSupport.StyleableUI {
    ...
    protected void installDocumentListener() {
        ...
        this.documentListener = new FlatDocumentListener(this, null);
    ...
    protected void installLayout() {
        ...
        if (!(oldLayout instanceof FlatTextFieldLayout)) {
            c.setLayout((LayoutManager)new FlatTextFieldLayout(this, oldLayout));
        }
    }

    static /* synthetic */ JTextComponent access$100(FlatTextFieldUI x0) {
