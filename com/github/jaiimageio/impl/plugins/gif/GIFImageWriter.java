...
import com.github.jaiimageio.impl.plugins.gif.GIFImageWriteParam;
import com.github.jaiimageio.impl.plugins.gif.GIFImageWriterSpi;
import com.github.jaiimageio.impl.plugins.gif.GIFWritableImageMetadata;
import com.github.jaiimageio.impl.plugins.gif.GIFWritableStreamMetadata;
...
extends ImageWriter {
    ...
    public IIOMetadata convertImageMetadata(IIOMetadata inData, ImageTypeSpecifier imageType, ImageWriteParam param) {
        ...
        this.convertMetadata(IMAGE_METADATA_NAME, inData, (IIOMetadata)im);
    ...
    public void prepareWriteSequence(IIOMetadata streamMetadata) throws IOException {
        ...
        if (streamMetadata == null) {
            ...
            this.convertMetadata(STREAM_METADATA_NAME, streamMetadata, (IIOMetadata)this.theStreamMetadata);
        }
    ...
    public void write(IIOMetadata sm, IIOImage iioimage, ImageWriteParam p) throws IOException {
        ...
        this.write(true, true, (IIOMetadata)streamMetadata, iioimage, p);
    }
    ...
    public void writeToSequence(IIOImage image, ImageWriteParam param) throws IOException {
        ...
        this.write(!this.wroteSequenceHeader, false, (IIOMetadata)this.theStreamMetadata, image, param);
    ...
    private void write(boolean writeHeader, boolean writeTrailer, IIOMetadata sm, IIOImage iioimage, ImageWriteParam p) throws IOException {
        ...
        if (this.needToCreateIndex(image)) {
            image = PaletteBuilder.createIndexedImage((RenderedImage)image);
        ...
        if (iioimage.getMetadata() != null) {
            ...
            this.convertMetadata(IMAGE_METADATA_NAME, iioimage.getMetadata(), (IIOMetadata)imageMetadata);
        ...
        if (writeHeader) {
            ...
            this.writeHeader((IIOMetadata)streamMetadata, bitsPerPixel);
