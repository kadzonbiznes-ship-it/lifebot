...
import com.github.jaiimageio.impl.plugins.tiff.TIFFDeflateDecompressor;
...
import com.github.jaiimageio.impl.plugins.tiff.TIFFLSBDecompressor;
import com.github.jaiimageio.impl.plugins.tiff.TIFFLZWDecompressor;
import com.github.jaiimageio.impl.plugins.tiff.TIFFNullDecompressor;
import com.github.jaiimageio.impl.plugins.tiff.TIFFOldJPEGDecompressor;
import com.github.jaiimageio.impl.plugins.tiff.TIFFPackBitsDecompressor;
import com.github.jaiimageio.impl.plugins.tiff.TIFFRenderedImage;
...
import com.github.jaiimageio.impl.plugins.tiff.TIFFYCbCrDecompressor;
...
extends ImageReader {
    ...
    private long getTileOrStripByteCount(int tileIndex) throws IOException {
        ...
        if (f != null) {
            ...
            tileOrStripByteCount = bytesPerRow * this.getTileOrStripHeight();
    ...
    public Iterator getImageTypes(int imageIndex) throws IIOException {
        ...
        if (this.imageTypeMap.containsKey(imageIndexInteger)) {
            ...
            l = new ArrayList(1);
            this.seekToImage(imageIndex);
            ImageTypeSpecifier itsRaw = TIFFDecompressor.getRawImageTypeSpecifier((int)this.photometricInterpretation, (int)this.compression, (int)this.samplesPerPixel, (int[])this.bitsPerSample, (int[])this.sampleFormat, (int[])this.extraSamples, (char[])this.colorMap);
    ...
    private void prepareRead(int imageIndex, ImageReadParam param) throws IOException {
        ...
        for (i = 0; i < this.sourceBands.length; ++i) {
            ...
            if (db >= 0 && db < destNumBands) continue;
    ...
    public BufferedImage read(int imageIndex, ImageReadParam param) throws IOException {
        ...
        this.decompressor.setReader((ImageReader)this);
        this.decompressor.setMetadata((IIOMetadata)this.imageMetadata);
    ...
    protected boolean isLsb() {
        ...
        boolean isLsb = false;
        if (null != this.imageMetadata && (fillOrderField = this.imageMetadata.getTIFFField(266)) != null && fillOrderField.getAsInt(0) == 2) {
            isLsb = true;
        }
        return isLsb;
    }
