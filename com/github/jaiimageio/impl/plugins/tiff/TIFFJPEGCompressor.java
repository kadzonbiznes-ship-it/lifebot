 ...
 *  com.github.jaiimageio.impl.plugins.tiff.TIFFJPEGCompressor$JPEGSPIFilter
 */
...
extends TIFFBaseJPEGCompressor {
    ...
    private static ImageReader getJPEGTablesReader() {
        ...
        try {
            ...
            Iterator<?> readerSPIs = registry.getServiceProviders(imageReaderClass, (ServiceRegistry.Filter)new JPEGSPIFilter(), true);
