...
extends ImageWriter {
    ...
    public void setOutput(Object output) {
        ...
        if (output != null) {
            if (!(output instanceof ImageOutputStream)) {
                throw new IllegalArgumentException(I18N.getString((String)"WBMPImageWriter"));
            }
    ...
    public void write(IIOMetadata streamMetadata, IIOImage image, ImageWriteParam param) throws IOException {
        if (this.stream == null) {
            throw new IllegalStateException(I18N.getString((String)"WBMPImageWriter3"));
        }
        if (image == null) {
            throw new IllegalArgumentException(I18N.getString((String)"WBMPImageWriter4"));
        }
        ...
        if (sourceRegion.isEmpty()) {
            throw new RuntimeException(I18N.getString((String)"WBMPImageWriter1"));
        }
    ...
    private void checkSampleModel(SampleModel sm) {
        ...
        if (type < 0 || type > 3 || sm.getNumBands() != 1 || sm.getSampleSize(0) != 1) {
            throw new IllegalArgumentException(I18N.getString((String)"WBMPImageWriter2"));
        }
    }
}
