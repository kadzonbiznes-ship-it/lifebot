...
import com.github.jaiimageio.impl.common.I18N;
...
public class ImageUtil {
                ...
                block30: {
                    block28: {
                        ...
                        if (!ImageUtil.isBinary(sm)) {
                            throw new IllegalArgumentException(I18N.getString((String)"ImageUtil0"));
                        }
                        int rectX = rect.x;
                        int rectY = rect.y;
    ...
    public static ColorModel createColorModel(ColorSpace colorSpace, SampleModel sampleModel) {
        ColorModel colorModel = null;
        if (sampleModel == null) {
            throw new IllegalArgumentException(I18N.getString((String)"ImageUtil1"));
        }
        int numBands = sampleModel.getNumBands();
    ...
    public static final void canEncodeImage(ImageWriter writer, ImageTypeSpecifier type) throws IIOException {
        ...
        if (type != null && spi != null && !spi.canEncodeImage(type)) {
            throw new IIOException(I18N.getString((String)"ImageUtil2") + " " + writer.getClass().getName());
        }
    }
    ...
    public static List getJDKImageReaderWriterSPI(ServiceRegistry registry, String formatName, boolean isReader) {
        ...
        Iterator<ImageReaderSpi> iter = ServiceLoader.load(spiClass).iterator();
    ...
    public static void processOnRegistration(ServiceRegistry registry, Class category, String formatName, ImageReaderWriterSpi spi, int deregisterJvmVersion, int priorityJvmVersion) {
        ...
        int jvmVersion = ImageUtil.getJvmVersion(jvmSpecificationVersion);
        if (jvmVendor.equals("Sun Microsystems Inc.")) {
            List list = spi instanceof ImageReaderSpi ? ImageUtil.getJDKImageReaderWriterSPI(registry, formatName, true) : ImageUtil.getJDKImageReaderWriterSPI(registry, formatName, false);
