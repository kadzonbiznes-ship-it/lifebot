...
implements ContextAware {
    ...
    public void addWarn(String msg) {
        this.addStatus((Status)new WarnStatus(msg, this.getOrigin()));
    }

    @Override
    public void addWarn(String msg, Throwable ex) {
        this.addStatus((Status)new WarnStatus(msg, this.getOrigin(), ex));
    }

    @Override
    public void addError(String msg) {
        this.addStatus((Status)new ErrorStatus(msg, this.getOrigin()));
    }

    @Override
    public void addError(String msg, Throwable ex) {
        this.addStatus((Status)new ErrorStatus(msg, this.getOrigin(), ex));
    }
}
