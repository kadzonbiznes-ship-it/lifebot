...
implements ContextAware {
    ...
    public void addWarn(String msg) {
        this.addStatus((Status)new WarnStatus(msg, this.getDeclaredOrigin()));
    }

    @Override
    public void addWarn(String msg, Throwable ex) {
        this.addStatus((Status)new WarnStatus(msg, this.getDeclaredOrigin(), ex));
    }

    @Override
    public void addError(String msg) {
        this.addStatus((Status)new ErrorStatus(msg, this.getDeclaredOrigin()));
    }

    @Override
    public void addError(String msg, Throwable ex) {
        this.addStatus((Status)new ErrorStatus(msg, this.getDeclaredOrigin(), ex));
    }
}
