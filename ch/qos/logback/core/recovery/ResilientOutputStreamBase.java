...
extends OutputStream {
    ...
    public void postIOFailure(IOException e) {
        this.addStatusIfCountNotOverLimit((Status)new ErrorStatus("IO failure while writing to " + this.getDescription(), (Object)this, (Throwable)e));
    ...
    void attemptRecovery() {
        ...
        try {
            ...
            this.addStatusIfCountNotOverLimit((Status)new ErrorStatus("Failed to open " + this.getDescription(), (Object)this, (Throwable)e));
        }
    }
