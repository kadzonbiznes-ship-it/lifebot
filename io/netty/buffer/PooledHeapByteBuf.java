...
extends PooledByteBuf<byte[]> {
    private static final ObjectPool<PooledHeapByteBuf> RECYCLER = ObjectPool.newPool(new /* Unavailable Anonymous Inner Class!! */);
    ...
    protected byte _getByte(int index) {
        return HeapByteBufUtil.getByte((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected short _getShort(int index) {
        return HeapByteBufUtil.getShort((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected short _getShortLE(int index) {
        return HeapByteBufUtil.getShortLE((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected int _getUnsignedMedium(int index) {
        return HeapByteBufUtil.getUnsignedMedium((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected int _getUnsignedMediumLE(int index) {
        return HeapByteBufUtil.getUnsignedMediumLE((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected int _getInt(int index) {
        return HeapByteBufUtil.getInt((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected int _getIntLE(int index) {
        return HeapByteBufUtil.getIntLE((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected long _getLong(int index) {
        return HeapByteBufUtil.getLong((byte[])((byte[])this.memory), (int)this.idx(index));
    }

    @Override
    protected long _getLongLE(int index) {
        return HeapByteBufUtil.getLongLE((byte[])((byte[])this.memory), (int)this.idx(index));
    }
    ...
    protected void _setByte(int index, int value) {
        HeapByteBufUtil.setByte((byte[])((byte[])this.memory), (int)this.idx(index), (int)value);
    }

    @Override
    protected void _setShort(int index, int value) {
        HeapByteBufUtil.setShort((byte[])((byte[])this.memory), (int)this.idx(index), (int)value);
    }

    @Override
    protected void _setShortLE(int index, int value) {
        HeapByteBufUtil.setShortLE((byte[])((byte[])this.memory), (int)this.idx(index), (int)value);
    }

    @Override
    protected void _setMedium(int index, int value) {
        HeapByteBufUtil.setMedium((byte[])((byte[])this.memory), (int)this.idx(index), (int)value);
    }

    @Override
    protected void _setMediumLE(int index, int value) {
        HeapByteBufUtil.setMediumLE((byte[])((byte[])this.memory), (int)this.idx(index), (int)value);
    }

    @Override
    protected void _setInt(int index, int value) {
        HeapByteBufUtil.setInt((byte[])((byte[])this.memory), (int)this.idx(index), (int)value);
    }

    @Override
    protected void _setIntLE(int index, int value) {
        HeapByteBufUtil.setIntLE((byte[])((byte[])this.memory), (int)this.idx(index), (int)value);
    }

    @Override
    protected void _setLong(int index, long value) {
        HeapByteBufUtil.setLong((byte[])((byte[])this.memory), (int)this.idx(index), (long)value);
    }

    @Override
    protected void _setLongLE(int index, long value) {
        HeapByteBufUtil.setLongLE((byte[])((byte[])this.memory), (int)this.idx(index), (long)value);
    }
