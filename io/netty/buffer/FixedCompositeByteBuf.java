...
extends AbstractReferenceCountedByteBuf {
    ...
    protected byte _getByte(int index) {
        ...
        return c.buf.getByte(index - Component.access$000((Component)c));
    }

    @Override
    protected short _getShort(int index) {
        Component c = this.findComponent(index);
        if (index + 2 <= Component.access$100((Component)c)) {
            return c.buf.getShort(index - Component.access$000((Component)c));
        }
    ...
    protected short _getShortLE(int index) {
        Component c = this.findComponent(index);
        if (index + 2 <= Component.access$100((Component)c)) {
            return c.buf.getShortLE(index - Component.access$000((Component)c));
        }
        if (this.order() == ByteOrder.BIG_ENDIAN) {
            return (short)(this._getByte(index) & 0xFF | (this._getByte(index + 1) & 0xFF) << 8);
        }
    ...
    protected int _getUnsignedMedium(int index) {
        Component c = this.findComponent(index);
        if (index + 3 <= Component.access$100((Component)c)) {
            return c.buf.getUnsignedMedium(index - Component.access$000((Component)c));
        }
        if (this.order() == ByteOrder.BIG_ENDIAN) {
    ...
    protected int _getUnsignedMediumLE(int index) {
        Component c = this.findComponent(index);
        if (index + 3 <= Component.access$100((Component)c)) {
            return c.buf.getUnsignedMediumLE(index - Component.access$000((Component)c));
        }
        if (this.order() == ByteOrder.BIG_ENDIAN) {
    ...
    protected int _getInt(int index) {
        Component c = this.findComponent(index);
        if (index + 4 <= Component.access$100((Component)c)) {
            return c.buf.getInt(index - Component.access$000((Component)c));
        }
        if (this.order() == ByteOrder.BIG_ENDIAN) {
    ...
    protected int _getIntLE(int index) {
        Component c = this.findComponent(index);
        if (index + 4 <= Component.access$100((Component)c)) {
            return c.buf.getIntLE(index - Component.access$000((Component)c));
        }
        if (this.order() == ByteOrder.BIG_ENDIAN) {
    ...
    protected long _getLong(int index) {
        Component c = this.findComponent(index);
        if (index + 8 <= Component.access$100((Component)c)) {
            return c.buf.getLong(index - Component.access$000((Component)c));
        }
        if (this.order() == ByteOrder.BIG_ENDIAN) {
    ...
    protected long _getLongLE(int index) {
        Component c = this.findComponent(index);
        if (index + 8 <= Component.access$100((Component)c)) {
            return c.buf.getLongLE(index - Component.access$000((Component)c));
        }
        if (this.order() == ByteOrder.BIG_ENDIAN) {
    ...
    public ByteBuf getBytes(int index, byte[] dst, int dstIndex, int length) {
        ...
        Component c = this.findComponent(index);
        int i = Component.access$200((Component)c);
        int adjustment = Component.access$000((Component)c);
        ByteBuf s = c.buf;
        while (true) {
