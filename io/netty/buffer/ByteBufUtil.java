...
public final class ByteBufUtil {
    ...
    public static String hexDump(ByteBuf buffer, int fromIndex, int length) {
        return HexUtil.access$000((ByteBuf)buffer, (int)fromIndex, (int)length);
    }
    ...
    public static String hexDump(byte[] array, int fromIndex, int length) {
        return HexUtil.access$100((byte[])array, (int)fromIndex, (int)length);
    }
    ...
    static int firstIndexOf(AbstractByteBuf buffer, int fromIndex, int toIndex, byte value) {
        ...
        for (int i = 0; i < longCount; ++i) {
            ...
            long result = SWARUtil.applyPattern((long)word, (long)pattern);
            if (result != 0L) {
    ...
    public static String prettyHexDump(ByteBuf buffer, int offset, int length) {
        return HexUtil.access$200((ByteBuf)buffer, (int)offset, (int)length);
    }
    ...
    public static void appendPrettyHexDump(StringBuilder dump, ByteBuf buf, int offset, int length) {
        HexUtil.access$300((StringBuilder)dump, (ByteBuf)buf, (int)offset, (int)length);
    }
    ...
    extends UnpooledDirectByteBuf {
        private static final ObjectPool<ThreadLocalDirectByteBuf> RECYCLER = ObjectPool.newPool(new /* Unavailable Anonymous Inner Class!! */);
    ...
    extends UnpooledUnsafeDirectByteBuf {
        private static final ObjectPool<ThreadLocalUnsafeDirectByteBuf> RECYCLER = ObjectPool.newPool(new /* Unavailable Anonymous Inner Class!! */);
