...
implements Iterable<ByteBuf> {
    ...
    static final ByteWrapper<byte[]> BYTE_ARRAY_WRAPPER = new /* Unavailable Anonymous Inner Class!! */;
    static final ByteWrapper<ByteBuffer> BYTE_BUFFER_WRAPPER = new /* Unavailable Anonymous Inner Class!! */;
        ...
        if (newCapacity > oldCapacity) {
            ...
            for (i = size - 1; i >= 0; --i) {
                ...
                if (bytesToTrim < cLength) {
                    ...
                    ByteBuf slice = Component.access$100((Component)c);
                    if (slice == null) break;
                    Component.access$102((Component)c, (ByteBuf)slice.slice(0, c.length()));
                    break;
                }
                c.free();
                bytesToTrim -= cLength;
    ...
    public CompositeByteBuf discardReadBytes() {
        ...
        ByteBuf slice = Component.access$100((Component)c);
        if (slice != null) {
            Component.access$102((Component)c, (ByteBuf)slice.slice(trimmedBytes, c.length()));
        }
