...
final class $Proxy4
extends Proxy
implements ChannelHandlerMask.Skip {
    ...
    static {
        ClassLoader classLoader = $Proxy4.class.getClassLoader();
        try {
            ...
            m3 = Class.forName("io.netty.channel.ChannelHandlerMask$Skip", false, classLoader).getMethod("annotationType", new Class[0]);
            return;
        }
