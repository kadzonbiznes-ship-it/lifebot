...
implements Cloneable {
    ...
    private ChannelFuture doBind(SocketAddress localAddress) {
        ...
        regFuture.addListener((GenericFutureListener<? extends Future<? super Void>>)new /* Unavailable Anonymous Inner Class!! */);
        return promise;
    }
    ...
    final ChannelFuture initAndRegister() {
        ...
        try {
            ...
            return new DefaultChannelPromise((Channel)new FailedChannel(), GlobalEventExecutor.INSTANCE).setFailure(t);
        }
    ...
    private static void doBind0(ChannelFuture regFuture, Channel channel, SocketAddress localAddress, ChannelPromise promise) {
        channel.eventLoop().execute((Runnable)new /* Unavailable Anonymous Inner Class!! */);
    }
    ...
    static /* synthetic */ void access$000(ChannelFuture x0, Channel x1, SocketAddress x2, ChannelPromise x3) {
        AbstractBootstrap.doBind0(x0, x1, x2, x3);
    }
