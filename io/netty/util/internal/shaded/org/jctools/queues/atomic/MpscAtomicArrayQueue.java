...
extends MpscAtomicArrayQueueL3Pad<E> {
    ...
    public boolean offerIfBelowThreshold(E e, int threshold) {
        ...
        int offset = AtomicQueueUtil.calcCircularRefElementOffset((long)pIndex, (long)mask);
        AtomicQueueUtil.soRefElement((AtomicReferenceArray)this.buffer, (int)offset, e);
        return true;
    }
    ...
    public E poll() {
        ...
        int offset = AtomicQueueUtil.calcCircularRefElementOffset((long)cIndex, (long)this.mask);
    ...
    public E relaxedPeek() {
        ...
        int mask = this.mask;
        long cIndex = this.lpConsumerIndex();
        return (E)AtomicQueueUtil.lvRefElement((AtomicReferenceArray)buffer, (int)AtomicQueueUtil.calcCircularRefElementOffset((long)cIndex, (long)mask));
    }
    ...
    public int fill(MessagePassingQueue.Supplier<E> s, int limit) {
        ...
        for (int i = 0; i < actualLimit; ++i) {
            int offset = AtomicQueueUtil.calcCircularRefElementOffset((long)(pIndex + (long)i), (long)mask);
