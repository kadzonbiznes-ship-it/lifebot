...
extends BaseLinkedQueue<E> {
    ...
    public boolean offer(E e) {
        ...
        LinkedQueueNode oldNode = this.lpProducerNode();
    ...
    public int fill(MessagePassingQueue.Supplier<E> s, int limit) {
        ...
        LinkedQueueNode<Object> head = tail = this.newNode(s.get());
        for (int i = 1; i < limit; ++i) {
            LinkedQueueNode<Object> temp = this.newNode(s.get());
            tail.spNext(temp);
            tail = temp;
        }
