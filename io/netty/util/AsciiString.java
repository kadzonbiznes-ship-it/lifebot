...
Comparable<CharSequence> {
    ...
    public static final HashingStrategy<CharSequence> CASE_INSENSITIVE_HASHER = new /* Unavailable Anonymous Inner Class!! */;
    public static final HashingStrategy<CharSequence> CASE_SENSITIVE_HASHER = new /* Unavailable Anonymous Inner Class!! */;
    ...
    public AsciiString toLowerCase() {
        return AsciiStringUtil.toLowerCase((AsciiString)this);
    }

    public AsciiString toUpperCase() {
        return AsciiStringUtil.toUpperCase((AsciiString)this);
    }
    ...
    public static boolean contains(CharSequence a, CharSequence b) {
        return AsciiString.contains(a, b, (CharEqualityComparator)DefaultCharEqualityComparator.INSTANCE);
    }

    public static boolean containsIgnoreCase(CharSequence a, CharSequence b) {
        return AsciiString.contains(a, b, (CharEqualityComparator)AsciiCaseInsensitiveCharEqualityComparator.INSTANCE);
    }
    ...
    public static boolean regionMatches(CharSequence cs, boolean ignoreCase, int csStart, CharSequence string, int start, int length) {
        ...
        return AsciiString.regionMatchesCharSequences(cs, csStart, string, start, length, (CharEqualityComparator)(ignoreCase ? GeneralCaseInsensitiveCharEqualityComparator.INSTANCE : DefaultCharEqualityComparator.INSTANCE));
    }
    ...
    public static boolean regionMatchesAscii(CharSequence cs, boolean ignoreCase, int csStart, CharSequence string, int start, int length) {
        ...
        return AsciiString.regionMatchesCharSequences(cs, csStart, string, start, length, (CharEqualityComparator)(ignoreCase ? AsciiCaseInsensitiveCharEqualityComparator.INSTANCE : DefaultCharEqualityComparator.INSTANCE));
    }
    ...
    private static boolean equalsIgnoreCase(byte a, byte b) {
        return a == b || AsciiStringUtil.toLowerCase((byte)a) == AsciiStringUtil.toLowerCase((byte)b);
    }
    ...
    private static byte toUpperCase(byte b) {
        return AsciiStringUtil.toUpperCase((byte)b);
    }

    public static boolean isUpperCase(byte value) {
        return AsciiStringUtil.isUpperCase((byte)value);
    }
    ...
    static /* synthetic */ boolean access$000(char x0, char x1) {
        return AsciiString.equalsIgnoreCase(x0, x1);
    }
}
