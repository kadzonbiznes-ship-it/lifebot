...
class MethodHandleBooleanFieldAccessorImpl
extends MethodHandleFieldAccessorImpl {
    static FieldAccessorImpl fieldAccessor(Field field, MethodHandle getter, MethodHandle setter, boolean isReadOnly) {
        ...
        if (isStatic) {
            getter = getter.asType(MethodType.methodType(Boolean.TYPE));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Boolean.TYPE));
            }
        } else {
            getter = getter.asType(MethodType.methodType(Boolean.TYPE, Object.class));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Object.class, Boolean.TYPE));
            }
        }
    ...
    public void setBoolean(Object obj, boolean z) throws IllegalArgumentException, IllegalAccessException {
        ...
        try {
            if (this.isStatic()) {
                this.setter.invokeExact(z);
            } else {
                this.setter.invokeExact(obj, z);
            }
        }
        catch (IllegalArgumentException | NullPointerException e) {
            throw e;
