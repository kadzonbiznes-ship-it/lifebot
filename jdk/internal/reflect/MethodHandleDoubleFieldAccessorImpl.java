...
class MethodHandleDoubleFieldAccessorImpl
extends MethodHandleFieldAccessorImpl {
    static FieldAccessorImpl fieldAccessor(Field field, MethodHandle getter, MethodHandle setter, boolean isReadOnly) {
        ...
        if (isStatic) {
            getter = getter.asType(MethodType.methodType(Double.TYPE));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Double.TYPE));
            }
        } else {
            getter = getter.asType(MethodType.methodType(Double.TYPE, Object.class));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Object.class, Double.TYPE));
            }
        }
    ...
    public void set(Object obj, Object value) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (value instanceof Byte) {
            Byte b = (Byte)value;
            this.setDouble(obj, b.byteValue());
        } else if (value instanceof Short) {
            Short s = (Short)value;
            this.setDouble(obj, s.shortValue());
        } else if (value instanceof Character) {
            Character c = (Character)value;
            this.setDouble(obj, c.charValue());
        } else if (value instanceof Integer) {
            Integer i = (Integer)value;
            this.setDouble(obj, i.intValue());
        } else if (value instanceof Long) {
            Long l = (Long)value;
            this.setDouble(obj, l.longValue());
        } else if (value instanceof Float) {
            Float f = (Float)value;
            this.setDouble(obj, f.floatValue());
    ...
    public void setDouble(Object obj, double d) throws IllegalArgumentException, IllegalAccessException {
        ...
        try {
            if (this.isStatic()) {
                this.setter.invokeExact(d);
            } else {
                this.setter.invokeExact(obj, d);
            }
        }
        catch (IllegalArgumentException | NullPointerException e) {
            throw e;
