...
class MethodHandleShortFieldAccessorImpl
extends MethodHandleFieldAccessorImpl {
    static FieldAccessorImpl fieldAccessor(Field field, MethodHandle getter, MethodHandle setter, boolean isReadOnly) {
        ...
        if (isStatic) {
            getter = getter.asType(MethodType.methodType(Short.TYPE));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Short.TYPE));
            }
        } else {
            getter = getter.asType(MethodType.methodType(Short.TYPE, Object.class));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Object.class, Short.TYPE));
            }
        }
    ...
    public void setShort(Object obj, short s) throws IllegalArgumentException, IllegalAccessException {
        ...
        try {
            if (this.isStatic()) {
                this.setter.invokeExact(s);
            } else {
                this.setter.invokeExact(obj, s);
            }
        }
        catch (IllegalArgumentException | NullPointerException e) {
            throw e;
