...
class MethodHandleIntegerFieldAccessorImpl
extends MethodHandleFieldAccessorImpl {
    static FieldAccessorImpl fieldAccessor(Field field, MethodHandle getter, MethodHandle setter, boolean isReadOnly) {
        ...
        if (isStatic) {
            getter = getter.asType(MethodType.methodType(Integer.TYPE));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Integer.TYPE));
            }
        } else {
            getter = getter.asType(MethodType.methodType(Integer.TYPE, Object.class));
            if (setter != null) {
                setter = setter.asType(MethodType.methodType(Void.TYPE, Object.class, Integer.TYPE));
            }
        }
    ...
    public void set(Object obj, Object value) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (value instanceof Byte) {
            Byte b = (Byte)value;
            this.setInt(obj, b.byteValue());
        } else if (value instanceof Short) {
            Short s = (Short)value;
            this.setInt(obj, s.shortValue());
        } else if (value instanceof Character) {
            Character c = (Character)value;
            this.setInt(obj, c.charValue());
    ...
    public void setInt(Object obj, int i) throws IllegalArgumentException, IllegalAccessException {
        if (this.isReadOnly()) {
            this.ensureObj(obj);
            this.throwFinalFieldIllegalAccessException(i);
        }
        try {
            if (this.isStatic()) {
                this.setter.invokeExact(i);
            } else {
                this.setter.invokeExact(obj, i);
            }
        }
        catch (IllegalArgumentException | NullPointerException e) {
            throw e;
