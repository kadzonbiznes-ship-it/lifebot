...
public final class XMLSecurityManager {
    ...
    public boolean isSecureProcessingSet() {
        return this.secureProcessingSet;
    }
    ...
    public static enum Limit {
        ...
        private Limit(String key, String apiProperty, String systemProperty, int value, int secureValue, Processor processor) {
            this.key = key;
