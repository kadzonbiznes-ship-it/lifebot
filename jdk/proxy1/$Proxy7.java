...
implements ElementCategories {
    ...
    @Override
    public final Category[] value() {
        try {
            return (Category[])this.h.invoke(this, m3, null);
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    static {
        ClassLoader classLoader = $Proxy7.class.getClassLoader();
        try {
            ...
            m3 = Class.forName("com.github.weisj.jsvg.nodes.prototype.spec.ElementCategories", false, classLoader).getMethod("value", new Class[0]);
            m4 = Class.forName("com.github.weisj.jsvg.nodes.prototype.spec.ElementCategories", false, classLoader).getMethod("annotationType", new Class[0]);
            return;
        }
