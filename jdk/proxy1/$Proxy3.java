...
implements ChannelHandler.Sharable {
    ...
    static {
        ClassLoader classLoader = $Proxy3.class.getClassLoader();
        try {
            ...
            m3 = Class.forName("io.netty.channel.ChannelHandler$Sharable", false, classLoader).getMethod("annotationType", new Class[0]);
            return;
        }
