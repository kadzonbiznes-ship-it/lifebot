...
implements Psapi {
    ...
    public $Proxy15(InvocationHandler invocationHandler) {
    ...
    public final boolean QueryWorkingSetEx(WinNT.HANDLE hANDLE, Pointer pointer, int n) {
        try {
            return (Boolean)this.h.invoke(this, m3, new Object[]{hANDLE, pointer, n});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final boolean EnumProcessModules(WinNT.HANDLE hANDLE, WinDef.HMODULE[] hMODULEArray, int n, IntByReference intByReference) {
        try {
            return (Boolean)this.h.invoke(this, m4, new Object[]{hANDLE, hMODULEArray, n, intByReference});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final boolean GetPerformanceInfo(Psapi.PERFORMANCE_INFORMATION pERFORMANCE_INFORMATION, int n) {
        try {
            return (Boolean)this.h.invoke(this, m6, new Object[]{pERFORMANCE_INFORMATION, n});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final int GetModuleFileNameEx(WinNT.HANDLE hANDLE, WinNT.HANDLE hANDLE2, Pointer pointer, int n) {
        try {
            return (Integer)this.h.invoke(this, m7, new Object[]{hANDLE, hANDLE2, pointer, n});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final int GetModuleFileNameExA(WinNT.HANDLE hANDLE, WinNT.HANDLE hANDLE2, byte[] byArray, int n) {
        try {
            return (Integer)this.h.invoke(this, m8, new Object[]{hANDLE, hANDLE2, byArray, n});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final int GetModuleFileNameExW(WinNT.HANDLE hANDLE, WinNT.HANDLE hANDLE2, char[] cArray, int n) {
        try {
            return (Integer)this.h.invoke(this, m9, new Object[]{hANDLE, hANDLE2, cArray, n});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final boolean GetModuleInformation(WinNT.HANDLE hANDLE, WinDef.HMODULE hMODULE, Psapi.MODULEINFO mODULEINFO, int n) {
        try {
            return (Boolean)this.h.invoke(this, m10, new Object[]{hANDLE, hMODULE, mODULEINFO, n});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    public final int GetProcessImageFileName(WinNT.HANDLE hANDLE, char[] cArray, int n) {
        try {
            return (Integer)this.h.invoke(this, m11, new Object[]{hANDLE, cArray, n});
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    static {
        ClassLoader classLoader = $Proxy15.class.getClassLoader();
        try {
            ...
            m3 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("QueryWorkingSetEx", Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("com.sun.jna.Pointer", false, classLoader), Integer.TYPE);
            m4 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("EnumProcessModules", Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("[Lcom.sun.jna.platform.win32.WinDef$HMODULE;", false, classLoader), Integer.TYPE, Class.forName("com.sun.jna.ptr.IntByReference", false, classLoader));
            ...
            m6 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("GetPerformanceInfo", Class.forName("com.sun.jna.platform.win32.Psapi$PERFORMANCE_INFORMATION", false, classLoader), Integer.TYPE);
            m7 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("GetModuleFileNameEx", Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("com.sun.jna.Pointer", false, classLoader), Integer.TYPE);
            m8 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("GetModuleFileNameExA", Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("[B", false, classLoader), Integer.TYPE);
            m9 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("GetModuleFileNameExW", Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("[C", false, classLoader), Integer.TYPE);
            m10 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("GetModuleInformation", Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("com.sun.jna.platform.win32.WinDef$HMODULE", false, classLoader), Class.forName("com.sun.jna.platform.win32.Psapi$MODULEINFO", false, classLoader), Integer.TYPE);
            m11 = Class.forName("com.sun.jna.platform.win32.Psapi", false, classLoader).getMethod("GetProcessImageFileName", Class.forName("com.sun.jna.platform.win32.WinNT$HANDLE", false, classLoader), Class.forName("[C", false, classLoader), Integer.TYPE);
            return;
        }
