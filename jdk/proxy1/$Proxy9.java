...
extends Proxy
implements Structure.FieldOrder {
    ...
    static {
        ClassLoader classLoader = $Proxy9.class.getClassLoader();
        try {
            ...
            m3 = Class.forName("com.sun.jna.Structure$FieldOrder", false, classLoader).getMethod("value", new Class[0]);
            m4 = Class.forName("com.sun.jna.Structure$FieldOrder", false, classLoader).getMethod("annotationType", new Class[0]);
            return;
        }
