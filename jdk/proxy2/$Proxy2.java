...
implements Retention {
    ...
    public final RetentionPolicy value() {
        try {
            return (RetentionPolicy)((Object)this.h.invoke(this, m3, null));
        }
        catch (Error | RuntimeException throwable) {
            throw throwable;
        }
    ...
    static {
        ...
        try {
            ...
            m3 = Class.forName("java.lang.annotation.Retention", false, classLoader).getMethod("value", new Class[0]);
            m4 = Class.forName("java.lang.annotation.Retention", false, classLoader).getMethod("annotationType", new Class[0]);
            return;
        }
