 ...
 *  org.lwjgl.system.StackWalkUtil
 */
...
implements AutoCloseable {
    ...
    public CLongBuffer mallocCLong(int size) {
        return CLongBuffer.create((long)this.nmalloc(CLONG_SIZE, size << CLONG_SHIFT), (int)size);
    }
    ...
    public CLongBuffer callocCLong(int size) {
        ...
        MemoryUtil.memSet(address, 0, bytes);
        return CLongBuffer.create((long)address, (int)size);
    }
    ...
    extends MemoryStack {
        ...
        public MemoryStack pop() {
            ...
            Object popped = StackWalkUtil.stackWalkCheckPop(MemoryStack.class, (Object)pushed);
            if (popped != null) {
