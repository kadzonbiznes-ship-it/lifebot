...
extends GL15 {
    ...
    public static void glGetShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer source) {
    ...
    public static void glGetShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") ByteBuffer source) {
        GL20C.glGetShaderSource(shader, length, source);
    }
