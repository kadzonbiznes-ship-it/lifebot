 ...
 *  net.miginfocom.swing.MigLayout$MyDebugRepaintListener
...
Externalizable {
    ...
    private void setComponentConstraintsImpl(Component comp, Object constr, boolean noCheck) {
        ...
        synchronized (object) {
            ...
            if (constr == null || constr instanceof String) {
                ...
                this.ccMap.put((ComponentWrapper)cw, ConstraintParser.parseComponentConstraint((String)cStr));
            } else if (constr instanceof CC) {
                this.scrConstrMap.put(comp, constr);
                this.ccMap.put((ComponentWrapper)cw, (CC)constr);
            } else {
    ...
    private void setDebug(ComponentWrapper parentW, boolean b) {
        if (b && (this.debugTimer == null || this.debugTimer.getDelay() != this.getDebugMillis())) {
            ...
            Component parent = (pCW = parentW.getParent()) != null ? (Component)pCW.getComponent() : null;
            this.debugTimer = new Timer(this.getDebugMillis(), (ActionListener)new MyDebugRepaintListener(this, null));
            if (parent != null) {
    ...
    public void layoutContainer(Container parent) {
        ...
        synchronized (object) {
            ...
            if (this.lastSize != (newSize = (long)this.grid.getHeight()[1] + ((long)this.grid.getWidth()[1] << 32))) {
                ...
                ContainerWrapper containerWrapper = this.checkParent(parent);
    ...
    private Dimension getSizeImpl(Container parent, int sizeType) {
        this.checkCache(parent);
        Insets i = parent.getInsets();
        int w = LayoutUtil.getSizeSafe((int[])(this.grid != null ? this.grid.getWidth() : null), (int)sizeType) + i.left + i.right;
        int h = LayoutUtil.getSizeSafe((int[])(this.grid != null ? this.grid.getHeight() : null), (int)sizeType) + i.top + i.bottom;
    ...
    static /* synthetic */ void access$100(MigLayout x0, ContainerWrapper x1) {
        x0.adjustWindowSize(x1);
    }

    static /* synthetic */ Grid access$200(MigLayout x0) {
        return x0.grid;
    }

    static /* synthetic */ Timer access$300(MigLayout x0) {
        return x0.debugTimer;
    }

    static /* synthetic */ Timer access$302(MigLayout x0, Timer x1) {
        x0.debugTimer = x1;
        return x0.debugTimer;
    }
}
