...
extends TIFFTagSet {
    ...
    extends TIFFTag {
        public JPEGInterchangeFormat() {
            super("JPEGInterchangeFormat", 513, 16, 1);
        }
    }
    ...
    extends TIFFTag {
        public JPEGInterchangeFormatLength() {
            super("JPEGInterchangeFormatLength", 514, 16, 1);
        }
    }
    ...
    extends TIFFTag {
        public JPEGRestartInterval() {
            super("JPEGRestartInterval", 515, 8, 1);
        }
    }
    ...
    extends TIFFTag {
        public PrimaryChromaticities() {
            super("PrimaryChromaticities", 319, 32, 6);
        }
    }
    ...
    extends TIFFTag {
        public YCbCrCoefficients() {
            super("YCbCrCoefficients", 529, 32, 3);
        }
    }
    ...
    extends TIFFTag {
        public YCbCrSubSampling() {
            super("YCbCrSubSampling", 530, 8, 2);
        }
    }
