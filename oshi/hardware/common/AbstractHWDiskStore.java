...
implements HWDiskStore {
    ...
    public String toString() {
        ...
        sb.append("size: ").append(this.getSize() > 0L ? FormatUtil.formatBytesDecimal((long)this.getSize()) : "?").append(", ");
        sb.append("reads: ").append(readwrite ? Long.valueOf(this.getReads()) : "?");
        sb.append(" (").append(readwrite ? FormatUtil.formatBytes((long)this.getReadBytes()) : "?").append("), ");
        sb.append("writes: ").append(readwrite ? Long.valueOf(this.getWrites()) : "?");
        sb.append(" (").append(readwrite ? FormatUtil.formatBytes((long)this.getWriteBytes()) : "?").append("), ");
