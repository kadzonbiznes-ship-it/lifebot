...
public final class PerfDataUtil {
        ...
        try (ByRef.CloseableLONGLONGByReference pllTimeStamp = new ByRef.CloseableLONGLONGByReference();){
            ...
            if (ret != 0) {
                if (LOG.isWarnEnabled()) {
                    LOG.warn("Failed to update counter. Error code: {}", (Object)String.format(Locale.ROOT, FormatUtil.formatError((int)ret), new Object[0]));
                }
                long l = 0L;
                return l;
            }
    ...
    public static boolean openQuery(WinNT.HANDLEByReference q) {
        ...
        if (ret != 0) {
            if (LOG.isErrorEnabled()) {
                LOG.error("Failed to open PDH Query. Error code: {}", (Object)String.format(Locale.ROOT, FormatUtil.formatError((int)ret), new Object[0]));
            }
            return false;
        }
        return true;
    ...
    public static long queryCounter(WinNT.HANDLEByReference counter) {
        try (Struct.CloseablePdhRawCounter counterValue = new Struct.CloseablePdhRawCounter();){
            ...
            if (ret != 0) {
                if (LOG.isWarnEnabled()) {
                    LOG.warn("Failed to get counter. Error code: {}", (Object)String.format(Locale.ROOT, FormatUtil.formatError((int)ret), new Object[0]));
                }
                long l = ret;
                return l;
            }
    ...
    public static boolean addCounter(WinNT.HANDLEByReference query, String path, WinNT.HANDLEByReference p) {
        ...
        if (ret != 0) {
            if (LOG.isWarnEnabled()) {
                LOG.warn("Failed to add PDH Counter: {}, Error code: {}", (Object)path, (Object)String.format(Locale.ROOT, FormatUtil.formatError((int)ret), new Object[0]));
            }
            return false;
        }
        return true;
