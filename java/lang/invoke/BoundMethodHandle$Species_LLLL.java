...
final class BoundMethodHandle$Species_LLLL
extends BoundMethodHandle {
    ...
    private BoundMethodHandle$Species_LLLL(MethodType methodType, LambdaForm lambdaForm, Object object, Object object2, Object object3, Object object4) {
    ...
    static BoundMethodHandle make(MethodType methodType, LambdaForm lambdaForm, Object object, Object object2, Object object3, Object object4) {
        return new BoundMethodHandle$Species_LLLL(methodType, lambdaForm, object, object2, object3, object4);
    }

    @Override
    final BoundMethodHandle copyWithExtendL(MethodType methodType, LambdaForm lambdaForm, Object object) throws Throwable {
        return (BoundMethodHandle)BMH_SPECIES.transformHelper(0).invokeBasic(methodType, lambdaForm, this.argL0, this.argL1, this.argL2, this.argL3, object);
    }

    @Override
    final BoundMethodHandle copyWithExtendI(MethodType methodType, LambdaForm lambdaForm, int n) throws Throwable {
        return (BoundMethodHandle)BMH_SPECIES.transformHelper(1).invokeBasic(methodType, lambdaForm, this.argL0, this.argL1, this.argL2, this.argL3, n);
    }

    @Override
    final BoundMethodHandle copyWithExtendJ(MethodType methodType, LambdaForm lambdaForm, long l) throws Throwable {
        return (BoundMethodHandle)BMH_SPECIES.transformHelper(2).invokeBasic(methodType, lambdaForm, this.argL0, this.argL1, this.argL2, this.argL3, l);
    }
